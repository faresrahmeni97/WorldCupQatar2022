...
public class EquipeControlleur {
        ...
        private static final Logger logger = LogManager.getLogger(com.example.demo.controlleur.EquipeControlleur.class);
        @Autowired
        ...
        public Equipe createUser(@Valid @RequestBody Equipe equipe) {
